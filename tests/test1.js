...
describe('Array', function () {
    it('It should return valid indexes of array for given number', function(){
        ...
        assert.deepEqual(result, [[0, 6], [1, 4], [3, 5]]);
    });
    xit('It should return valid indexes of array for given number', function(){
    ...
    // });
    xit('It should NOT return valid indexes of array for given number', function(){
        let arr = [6, -2, 3, 5, 7, 0, -1];
        let search = 5;
        let result = indexesOfSearchNumber(arr, search);
